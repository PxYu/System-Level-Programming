...
void BASEHELPER::PrintTheWin32Error( DWORD dwError )
{
   	...
   	else
	{
		...
		sprintf_s( strMessage, MAX_LENGTH, "GetLastError() Returned Error Code: 08%x", dwError );
...
DECLSPEC
/* static public */
HRESULT BASEHELPER::GetFunctionProperties( ICorProfilerInfo2 *pPrfInfo,
...
char *BASEHELPER::GetEERegistryKeySTRING( char *regKeyName )
{
    ...
    if ( (RegOpenKeyExA( HKEY_LOCAL_MACHINE, 
   	...
   	{                	        
   		...
   		sprintf_s( retValue, size + 1, "%s", buffer );  
